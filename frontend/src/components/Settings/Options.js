        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="group-type-label">
              Ignorar publicaciones grupales
            </InputLabel>
            <Select
      ...
      <Grid spacing={3} container>
        ...
        >
          <Tab
            ...
            label="Realiza tus acciones según tus necesidades o solicita apoyo a nuestro equipo de soporte. 🛠️💬" />
