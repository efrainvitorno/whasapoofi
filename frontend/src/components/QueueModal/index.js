...
const QueueModal = ({ open, onClose, queueId }) => {
  ...
  const [schedules, setSchedules] = useState([
    ...
    { weekday: "Juevez", weekdayEn: "thursday", startTime: "08:00", endTime: "18:00", },
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Tabs
          ...
          aria-label="ejemplo de pestañas deshabilitadas"
        >
          <Tab label="Datos del Area" />
          {schedulesEnabled && <Tab label="Horario de atencion" />}
        </Tabs>
        {tab === 0 && (
          <Paper>
            <Formik
                  ...
                  <DialogContent dividers>
                    ...
                    <div>
                      ...
                      >
                        ...
                        >
                          <MenuItem value={""} >{"Ningun"}</MenuItem>
