...
export default function CompaniesManager() {
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      ...
      toast.error(
        "La operación no se pudo realizar.. Verifique se já existe uma empresa com o mesmo nome ou se os campos foram preenchidos corretamente"
      );
    }
    setLoading(false);
  };
