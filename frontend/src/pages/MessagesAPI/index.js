  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. <br/>Para realizar el registro, acceda al menú "Conexiones", haga clic en el botón de editar de la conexión e ingrese el token en el campo correspondiente.</li>
          <li>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Método: </b> POST <br />
            <b>Encabezados: </b> X_TOKEN (token registrado) y Content-Type (application/json) <br />
            <b>Cuerpo: </b> {"{ \"number\": \"51930123123\", \"body\": \"Su mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación se muestra la lista de información necesaria para el envío de mensajes de medios:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Encabezados: </b> X_TOKEN (token registrado) y Content-Type (multipart/form-data) <br />
            <b>FormData: </b> <br />
            <ul>
              <li>
                <b>number: </b> 51930123123
              </li>
              <li>
                <b>medias: </b> archivo
              </li>
